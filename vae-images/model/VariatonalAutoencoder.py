...
DATA_FOLDER = '/Volumes/My Passport/PFM/output/'
RUN_FOLDER = '/Volumes/My Passport/PFM/run'
run_id = '0001'
data_name = 'cells'
RUN_FOLDER += '_'.join([run_id, '_', data_name])
...
filenames = np.array(glob(os.path.join(DATA_FOLDER, '*/*.tiff')))
...
t.train_with_generator(data_flow=data_flow, epochs=10, steps_per_epoch= NUM_IMAGES / BATCH_SIZE, run_folder=RUN_FOLDER, print_every_n_batches=10)
